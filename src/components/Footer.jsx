    ...
    <footer className="relative overflow-hidden bg-[#7B1E1E] text-white font-poppins">
      ...
      <div className="container-page py-12 relative">
        ...
        <div className="md:hidden text-center">
          ...
          <p className="text-sm mt-2 text-white/90 leading-relaxed max-w-sm mx-auto">
        ...
        {/* ===== GRID ===== */}
        <div className="mt-10 grid grid-cols-2 gap-10 md:mt-0 md:grid-cols-3">
          {/* DESKTOP BRAND (kolom 1) */}

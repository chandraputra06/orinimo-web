    ...
    <footer className="relative overflow-hidden bg-[#7B1E1E] text-white font-poppins">
      ...
      <div className="container-page py-12 relative">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-sm mt-2 text-white/90 leading-relaxed max-w-sm mx-auto md:mx-0">
        ...
        {/* ✅ Mobile: 2 kolom (Informasi + Kontak). Desktop: 3 kolom (Brand | Informasi | Kontak) */}
        <div className="mt-10 md:mt-12 grid grid-cols-2 gap-10 md:grid-cols-3">
          {/* Placeholder untuk menjaga layout desktop (kolom brand) */}
          <div className="hidden md:block" />

          {/* Informasi (isi tidak diubah) */}
          <div>
